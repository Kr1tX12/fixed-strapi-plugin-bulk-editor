...
const BulkEditModal = ({
  ...
  const [editedEntries, setEditedEntries] = require$$0.useState({});
  const [saving, setSaving] = require$$0.useState(false);
  const [schema, setSchema] = require$$0.useState(null);
  const [schemaLoading, setSchemaLoading] = require$$0.useState(true);
  const [dragStart, setDragStart] = require$$0.useState(null);
  const [dragCurrent, setDragCurrent] = require$$0.useState(null);
  const [relationOptions, setRelationOptions] = require$$0.useState({});
  const [hasUnsavedChanges, setHasUnsavedChanges] = require$$0.useState(false);
  const [showExitConfirm, setShowExitConfirm] = require$$0.useState(false);
  const [populatingRelations, setPopulatingRelations] = require$$0.useState(true);
  const [hoveredCell, setHoveredCell] = require$$0.useState(null);
  const [selectedCells, setSelectedCells] = require$$0.useState(/* @__PURE__ */ new Set());
  ...
  const renderFieldInput = (docId, field, value, fieldSchema, isLoading) => {
    ...
    if (fieldSchema?.type === "relation") {
      ...
      if (isManyRelation) {
        ...
        return /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { width: "100%", minWidth: "150px", ...disabledStyle }, children: [
          selectedItems.length > 0 && /* @__PURE__ */ jsxRuntime.jsx(
            "div",
            {
              style: {
                display: "flex",
              ...
              children: selectedItems.map((item) => /* @__PURE__ */ jsxRuntime.jsxs(
                "span",
                {
                  style: {
                    display: "inline-flex",
          ...
          /* @__PURE__ */ jsxRuntime.jsxs(
            "select",
            {
              ...
              disabled: isLoading,
              children: [
                /* @__PURE__ */ jsxRuntime.jsx("option", { value: "", children: "+ Add..." }),
                options.filter((opt) => !selectedIds.includes(opt.id)).map((option) => /* @__PURE__ */ jsxRuntime.jsx("option", { value: option.id, children: option.title || option.name || `#${option.id}` }, option.documentId || option.id))
              ]
            }
          )
        ] });
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs(
        "select",
        {
          ...
          children: [
            ...
            options.map((option) => /* @__PURE__ */ jsxRuntime.jsx("option", { value: option.id, children: option.title || option.name || `#${(option.documentId || option.id).slice(0, 8)}` }, option.documentId || option.id))
          ]
        }
      );
    }
    if (fieldSchema?.type === "enumeration" && fieldSchema.enum) {
      return /* @__PURE__ */ jsxRuntime.jsxs(
        "select",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntime.jsx("option", { value: "" }),
            fieldSchema.enum.map((option) => /* @__PURE__ */ jsxRuntime.jsx("option", { value: option, children: option }, option))
          ]
        }
      );
    }
    if (fieldSchema?.type === "media") {
      ...
      return /* @__PURE__ */ jsxRuntime.jsx(
        "div",
        {
          ...
          children: mediaUrl ? /* @__PURE__ */ jsxRuntime.jsx(
            "img",
            {
              src: mediaUrl,
              alt: "Preview",
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Modal.Root, { open: true, onOpenChange: handleClose, children: /* @__PURE__ */ jsxRuntime.jsxs(
      designSystem.Modal.Content,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Modal.Header, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { children: [
            /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Typography, { fontWeight: "bold", textColor: "neutral800", as: "h2", id: "title", children: [
              "Bulk Edit - ",
              documents.length,
              " ",
              documents.length === 1 ? "entry" : "entries"
            ] }),
            /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Typography, { variant: "omega", textColor: "neutral600", marginTop: 1, children: [
            ...
            !schemaLoading && /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "pi", textColor: "neutral500", marginTop: 2, children: "Note: Media fields are read-only previews. Edit them individually in each entry." })
          ] }) }),
          /* @__PURE__ */ jsxRuntime.jsx(
            designSystem.Modal.Body,
            {
              style: {
                padding: 0,
                margin: 0
              ...
              children: /* @__PURE__ */ jsxRuntime.jsx(
                designSystem.Box,
                {
                  ...
                  children: fields.length === 0 ? /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { style: { padding: "20px" }, children: "No editable fields found for these entries." }) : /* @__PURE__ */ jsxRuntime.jsxs(
                    designSystem.Table,
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntime.jsx(
                          designSystem.Thead,
                          {
                            ...
                            children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Tr, { children: [
                              /* @__PURE__ */ jsxRuntime.jsx(
                                designSystem.Th,
                                {
                                  style: {
                                  ...
                                  children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "sigma", textColor: "neutral600", children: "ID" })
                                }
                              ),
                              fields.map((field) => {
                                const fieldSchema = getFieldType(field);
                                ...
                                return /* @__PURE__ */ jsxRuntime.jsx(
                                  designSystem.Th,
                                  {
                                    ...
                                    children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "sigma", textColor: "neutral600", children: field })
                                  },
                                  field
                                );
                              })
                        ...
                        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Tbody, { children: documents.map((doc) => {
                          const docId = doc.documentId || doc.id;
                          ...
                          return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Tr, { children: [
                            /* @__PURE__ */ jsxRuntime.jsx(
                              designSystem.Td,
                              {
                                ...
                                children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Typography, { textColor: "neutral800", variant: "omega", children: [
                              ...
                              return /* @__PURE__ */ jsxRuntime.jsx(
                                designSystem.Td,
                                {
                                  ...
                                  children: /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { position: "relative" }, children: [
                                    ...
                                    !isMediaField && isHovered && !populatingRelations && /* @__PURE__ */ jsxRuntime.jsx(
                                      "div",
                                      {
          ...
          /* @__PURE__ */ jsxRuntime.jsx(
            designSystem.Modal.Footer,
            {
              ...
              children: schema?.options?.draftAndPublish ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
                /* @__PURE__ */ jsxRuntime.jsx(
                  designSystem.Button,
                  {
              ...
              ] }) : /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { onClick: () => handleSave(false), loading: saving, disabled: fields.length === 0 || populatingRelations, children: "Save All Changes" })
            }
          )
        ]
      }
    ) }),
    showExitConfirm && /* @__PURE__ */ jsxRuntime.jsx(designSystem.Modal.Root, { open: true, onOpenChange: handleCancelExit, children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Modal.Content, { children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Modal.Header, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { fontWeight: "bold", textColor: "neutral800", as: "h2", children: "Unsaved Changes" }) }),
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Modal.Body, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { children: "You have unsaved changes. Are you sure you want to exit without saving?" }) }),
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Modal.Footer, { children: [
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { onClick: handleCancelExit, variant: "tertiary", children: "Continue Editing" }),
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { onClick: handleConfirmExit, variant: "danger", children: "Exit Without Saving" })
      ] })
    ] }) })
  ] });
};
...
const ModalManager = () => {
  const [modalState, setModalState] = require$$0.useState({
    isOpen: false,
    documents: [],
    model: "",
    notificationFn: null,
...
async function mountModalManager() {
  ...
  modalMounted = true;
  const ReactDOMClient = await Promise.resolve().then(() => require("./client-B1Yh2zx6.js")).then((n) => n.client);
  const modalRoot = document.createElement("div");
  modalRoot.id = "bulk-editor-modal-root";
  document.body.appendChild(modalRoot);
  const root = ReactDOMClient.createRoot(modalRoot);
  root.render(
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.DesignSystemProvider, { locale: "en", children: /* @__PURE__ */ jsxRuntime.jsx(ModalManager, {}) })
  );
}
const index = {
  register(app) {
